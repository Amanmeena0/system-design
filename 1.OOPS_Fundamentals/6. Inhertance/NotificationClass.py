...
class PushNotification(Notification):
    def __init__(self, recipient:str, message:str, device_token:str, priority:str):
        super().__init__(recipient, message)
...
if __name__ == "__main__":
    email = EmailNotification("alice@example.com", "Your order has been shipped!", "Order Update")
    email.send()

    print()

    sms = SMSNotification("BOB", "Your verification code is 582910", "+1-555-01234")
    sms.send()

    print()
    
    push = PushNotification("Charlie", "New messages from Alice", "d8a3f42c1e5a9b7", "high")
    push.send()